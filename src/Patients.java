...
public class Patients extends javax.swing.JFrame {
    ...
    public void writeAllData() {
        ...
        for (Patient patient : allPatients) {
            allPData.append(patient.getId() + "   " + patient.getName() + "   " + patient.getAge() + "   " + patient.getGender() + "   " + patient.getAddress() + "   " + patient.getContact() + "\n"); // Added newline character
        }
    }
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(contact, javax.swing.GroupLayout.DEFAULT_SIZE, 222, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     else if(checkIDC())
     {
         ...
         patient.setName(name.getText());
          ...
          JOptionPane.showMessageDialog(null, "ID and age must be");   
         }
     }
// TODO add your handling code here:
     ...
     boolean checkIDC()
     {
         ...
         {
           if(id.getText().equals(allPatients.get(i).getId()+" ") || name.getText().equals(allPatients.get(i).getId()+" ") || age.getText().equals(allPatients.get(i).getId()+" ") || gender.getText().equals(allPatients.get(i).getId()+" ") || address.getText().equals(allPatients.get(i).getId()+" ") || contact.getText().equals(allPatients.get(i).getId()+" ")) 
           {
               return true;
           }
         }
